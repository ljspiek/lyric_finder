...
export default class Lyrics extends Component {
    ...
    componentDidMount() {
        axios.get(`https://cors-anywhere.herokuapp.com/https://api.musixmatch.com/ws/1.1/track.lyrics.get?track_id=${this.props.match.params.id}&apikey=${process.env.REACT_APP_MM_KEY}`)
            .then(res => {
                console.log("Lyrics first call", res.data)
            ...
            .then(res => {
                console.log("Lyrics/Track 2nd call", res.data);
            ...
            return (
                <React.Fragment>
                    ...
                    <ul className="list-group mt-3">
                        ...
                        <li className="list-group-item">
                            <strong>Updated Time</strong>:<Moment format="MM/DD/YYYY">{track.updated_time}</Moment>
                        </li>
                    </ul>
                </React.Fragment>
            )
